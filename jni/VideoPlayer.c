...
jstring Java_org_lance_videoplayer_FFmpeg_stringFromJNI(JNIEnv* env,
		jobject thiz) {
	return (*env)->NewStringUTF(env, "Helloworld from FFmpeg!");
}

void Java_org_lance_videoplayer_FFmpeg_nativeTest(JNIEnv* env, jobject thiz) {
	++test;
	sprintf(debugMsg, "%d", test);
	INFO(debugMsg);
}

jintArray Java_org_lance_videoplayer_FFmpeg_jniIntArray(JNIEnv* env,
		jobject thiz) {
	INFO("hi");
...
void Java_org_lance_videoplayer_FFmpeg_avRegisterAll(JNIEnv* env, jobject thiz) {
	av_register_all();
}
...
jboolean Java_org_lance_videoplayer_FFmpeg_avOpenInputFile(JNIEnv* env,
		jobject thiz, jstring jfilePath) {
...
jboolean Java_org_lance_videoplayer_FFmpeg_avFindStreamInfo(JNIEnv* env,
		jobject thiz) {
...
jboolean Java_org_lance_videoplayer_FFmpeg_findVideoStream(JNIEnv* env,
		jobject thiz) {
	videoStream = -1;
...
jboolean Java_org_lance_videoplayer_FFmpeg_avcodecFindDecoder(JNIEnv* env,
		jobject thiz) {
...
jboolean Java_org_lance_videoplayer_FFmpeg_avcodecOpen(JNIEnv* env,
		jobject thiz) {
...
void Java_org_lance_videoplayer_FFmpeg_avcodecAllocFrame(JNIEnv* env,
		jobject thiz) {
	pFrame = avcodec_alloc_frame();
}

void Java_org_lance_videoplayer_FFmpeg_avFree(JNIEnv* env, jobject thiz) {
	av_free(pFrame);
}

void Java_org_lance_videoplayer_FFmpeg_avcodecClose(JNIEnv* env, jobject thiz) {
	avcodec_close(pCodecCtx);
}

void Java_org_lance_videoplayer_FFmpeg_avCloseInputFile(JNIEnv* env,
		jobject thiz) {
...
jstring Java_org_lance_videoplayer_FFmpeg_getCodecName(JNIEnv* env,
		jobject thiz) {
	return (*env)->NewStringUTF(env, pCodec->name);
}

jint Java_org_lance_videoplayer_FFmpeg_getWidth(JNIEnv* env, jobject thiz) {
	width = pCodecCtx->width;
	return pCodecCtx->width;
}

jint Java_org_lance_videoplayer_FFmpeg_getHeight(JNIEnv* env, jobject thiz) {
	height = pCodecCtx->height;
	return pCodecCtx->height;
}

jint Java_org_lance_videoplayer_FFmpeg_getBitRate(JNIEnv* env, jobject thiz) {
	bit_rate = pCodecCtx->bit_rate;
	return pCodecCtx->bit_rate;
}

jboolean Java_org_lance_videoplayer_FFmpeg_allocateBuffer(JNIEnv* env,
		jobject thiz) {
...
void Java_org_lance_videoplayer_FFmpeg_setScreenSize(JNIEnv* env, jobject thiz,
...
jbyteArray Java_org_lance_videoplayer_FFmpeg_getNextDecodedFrame(JNIEnv* env,
		jobject thiz) {
...
jstring Java_org_lance_videoplayer_FFmpeg_play(JNIEnv* env, jobject thiz,
		jstring jfilePath) {
