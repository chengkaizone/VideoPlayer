...
public class FilePasteActivity extends ListActivity {
	...
	private void viewFiles(String filePath) {
		ArrayList<FileInfo> tmp = FileActivityHelper.getFiles(
				FilePasteActivity.this, filePath);
		if (tmp != null) {
			// 清空数据
			if (_files != null) {
				_files.clear();
	...
	private Button.OnClickListener fun_CreateDir = new Button.OnClickListener() {
		public void onClick(View v) {
			FileActivityHelper.createDir(FilePasteActivity.this, _currentPath,
					createDirHandler);
		}
	};
	...
	private Button.OnClickListener fun_Paste = new Button.OnClickListener() {
		public void onClick(View v) {
			...
			progressDialog = ProgressDialog.show(FilePasteActivity.this, "",
